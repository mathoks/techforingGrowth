...
import { planning, recordKeeping, adminList, registration, exEmployee, training } from "/src/dummyData.js";
  ...
  return (
    <div className="flex flex-col lg:gap-24 gap-12">
      ...
      <BusinessTeamCTA
        ...
        subTitle={
          <>
            <span className="text_gradient">Dive into Employee Data, Training Insights,<br />and More With</span> <span className="text-green font-bold lg:text-[22px] text-[9px]">TechForing Human!</span>
          </>
        }
      ...
      <AdvantageVsDisadvantage
        ...
        imgSrc={recordKeeping.ScreenShot}
        className={'lg:py-6'}
      />
      <AdvantageVsDisadvantage
        details={exEmployee}
      ...
      <StyledCTA
        ...
        content={
          <div>
            <div className="noto font-extralight lg:text-[28px] text-[14px] lg:leading-[85px] leading-[22px] text_gradient flex flex-col lg:items-start items-center">
              <span><span className="font-normal lg:text-[125px] text-[16px]">80%</span> of business </span>
            </div>
            <span className="noto font-extralight lg:text-[28px] text-[14px] text_gradient flex flex-col lg:-translate-y-5 lg:text-start text-center">Worldwide Use an HR Software</span>
            <div className='flex items-center gap-1 lg:gap-5 lg:flex-row flex-col'>
              <span>
                <span className="mb-2">
                  <span className='inter text-secondary-1 font-semibold lg:text-[18px] text-[12px]'>Get The Best
                    <span className='inter text-green font-semibold lg:text-[32px] text-[14px'>  HRMS </span>Today
                  </span>
                </span>
              </span>
