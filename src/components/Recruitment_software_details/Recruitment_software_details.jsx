...
import "./Recruitment_software_details.css"

const Recruitment_software_details = ({ details }) => {
    const { headTitle, content01, content02, ScreenShot } = details;

    return (
        <>
            <h2 className='text_gradient_recruitment inter lg:text-[36px] text-[18px] font-bold lg:mb-10 mb-[30px] lg:mr-[60px] mr-0'>{headTitle}</h2>
            <div className='flex items-center mb-[30px] lg:mr-[60px] mr-0'>
                <img src="/Recruitment/icons/stroke_dislike.webp" alt="" />
                <p className='lg:text-[16px] text-[14px] roboto ml-4 lg:leading-6 leading-[22px] text-light-gray font-light'>{content01}</p>
            </div>

            <div className="h-[250px] grid grid-cols-1 items-center relative z-[1] mb-10 lg:hidden ">
            ...
            <div className='content_div'>
                ...
                <div className='para_div'>
                    <img src="/Recruitment/icons/fill_like.webp" alt="" />
...
export default Recruitment_software_details;