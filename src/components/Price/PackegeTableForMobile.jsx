...
const PackegeTableForMobile = React.forwardRef(
            ...
            {data?.clone_products?.map((product, index) => (
              <div key={index}>
                <div className="main_container px-2 relative">
                  <div className="bg-[#EEF4FD] p-1 flex items-center justify-between">
                    <div>
                      ...
                      <h2 className="text-[#0F93B1] text-sm md:text-lg font-medium my-3 px-3">
...
export default PackegeTableForMobile;