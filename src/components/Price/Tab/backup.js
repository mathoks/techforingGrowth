...
import { paginationSliderOption } from "@/utils/sliderOptions";

const SeeMoreButton = ({ custom_colour }) => (
  <button
...
const PricingTabPreview = ({
  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className=" border-t-[0.5px] border-[#0F93B1] ">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center items-center py-3 ">
             { AvailaPaymentOptions.length > 1 && <div className="w-full sm:w-auto">
                <select
            ...
            <div className="main_container mx-auto overflow-auto px-4 md:px-0 w-[100%] ">
              <div className="relative py-4 mb-4 flex-col w-full bg-white">
                <Splide
                  ...
                  onVisible={({state})=>console.log(state)}
                  // className="   justify-start flex-row md:flex-row md:justify-start items-center gap-10 md:gap-3 py-4 px-0 md:px-1"
                  className="mx-auto border-4 scrollable-container space-x-10 flex  justify-center w-[280px] md:w-[calc(100%-10px)] py-8  h-[50rem] lg:w-full even:h-[30rem]"
                  // className="flex flex-col md:flex-row justify-center items-center gap-4 py-4"
                  // className=" flex md:flex-row md:justify-start items-center gap-2 md:gap-3 py-4 px-0 md:px-1"
                >
                  {/* <SplideTrack
                  ...
                  <div className="splide__arrows">
                    ...
                    <div className="splide__arrow splide__arrow--next rotate-90 flex items-center   rounded-none  w-32 bg-orange-400 justify-between ">
                      <span>
                        <ArrowUp />
                      </span>
                      <h2>show more</h2>
                  ...
                  {availableProduct[currentIndex]?.product_packages.map(
                    (
                      ...
                      <SplideSlide
                        ...
                        key={index}
                        className={`border inline-flex items-center gap-2 rounded-md flex-col  mx-auto justify-center px-10  min-w-[280px] md:w-[calc(50%-10px)] ${
                          index % 2 === 0 ? "even:h-[40rem]" : "odd:[30rem]"
                        } `}
                        style={{
                      ...
                      >
                        ...
                        <div className=" flex  absolute -top-2 ">
                          ...
                          >
                            ...
                            {is_most_popular && (
                              <div
                                className="flex flex-col justify-end items-center h-[40px] self-stretch -ml-5 pb-[6px] mt-1 w-[180px]"
                                style={{
      ...
      {/* </div> */}
      <div className="text-center mt-4">No data Ava</div>
    </div>
  );
};
