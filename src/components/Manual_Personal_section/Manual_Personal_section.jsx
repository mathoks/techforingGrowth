...
import "./Manual_Personal_section.css"

const Manual_Personal_section = ({ manual_resource }) => {
    const { headTitle, img1, img2, img3, para, content1, content2, content3, manualImage } = manual_resource;
        ...
        <section className="overflow-x-hidden lg:mt-20 mt-0">
            <div className="main_container flex lg:flex-row flex-col-reverse justify-between items-center lg:pb-[75px] pb-[50px] lg:pt-[75px] pt-0 relative px-4">
                ...
                <div className="lg:w-[50%] w-full">
                    <h2 className="text_gradient_personal lg:text-[36px] text-[20px] font-bold lg:leading-[50px] leading-[30px] mb-4 lg:pr-[100px] pr-0">{headTitle}</h2>
...
export default Manual_Personal_section;