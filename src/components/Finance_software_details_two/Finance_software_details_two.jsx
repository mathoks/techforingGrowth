...
import "./Finance_software_details_two.css"

const Finance_software_details_two = ({ details4 }) => {
    const { headTitle, content01, content02, ScreenShot  } = details4;
...
export default Finance_software_details_two;