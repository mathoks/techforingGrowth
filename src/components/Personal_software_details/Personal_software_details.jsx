...
const Personal_software_details = ({ details11 }) => {
    const { headTitle, content01, content02, ScreenShot } = details11;
    ...
    return (
        <>
            ...
            <div className="md:h-[550px] grid grid-cols-1 items-center relative z-[1] mb-10 lg:hidden ">
...
export default Personal_software_details;